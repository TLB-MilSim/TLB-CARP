params ["_vehicle"];
if (TLB_CARP_state_profileOverride in ["c17", "c130"]) exitWith {TLB_CARP_state_profileOverride};
...
// gated behind TLB_CARP_setting_allowDegradedAuto -- the same treatment the C-130 gets.
