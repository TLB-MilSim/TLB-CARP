/*
    ...
    behind the aircraft, say -- sets TLB_CARP_state_autoArmed = false directly and never
    ...
    TLB_CARP_state_syncSeenAuto. But fn_syncReconcile re-points that marker at the live
...
if (missionNamespace getVariable ["TLB_CARP_state_autoArmed", false]) then {
